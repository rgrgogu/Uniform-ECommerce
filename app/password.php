            ...
            <div id="profile">
                ...
                <div id="two-selector" class="grid sm:grid-cols-1 lg:grid-cols-2 gap-6">
                    <div id="left-panel-dot" class="lg:col-end-1">
                        ...
                        <div class="lg:p-2">
                            <a href="" class="font-bold">Password</a>
                        </div>
                        <div class="lg:p-2">
                    ...
                    <form id="right-panel-dot" class="lg:col-span-2">
                        <div id="information">
                            ...
                            <input type="password" placeholder="current password" class="border border-black p-3 px-4 rounded-lg mb-4 w-full mt-2" />
                            <label>New Password</label>
                            <input type="password" placeholder="new password" class="border border-black p-3 px-4 rounded-lg mb-4 w-full mt-2" />
